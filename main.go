...
import (
	...
	"github.com/mcastelino/jobqueue-operator/controllers"
...
func init() {
	...
	utilruntime.Must(batchjobsv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "3e87eea7.example.com",
	})
	if err != nil {
	...
	if err = (&controllers.JobQueueReconciler{
